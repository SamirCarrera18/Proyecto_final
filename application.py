...
def print():
    ...
    pswr = request.form.get("pswr_login")
...
def curriculum():
    ...
    return render_template("curriculum.html",nombre=nombre,apellidos=apellidos,dni=dni, presentacion=presentacion,
    ...
    workexp3_2=workexp3_2, workexp3_3=workexp3_3, sec=sec, sup=sup, mstr=mstr, doc=doc, hobbie1=hobbie1,
     hobbie2=hobbie2,hobbie3=hobbie3, hobbie4=hobbie4, pswr=pswr)
